<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="itemsincategory.aspx.cs" Inherits="itemsincategory" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    <SelectParameters>
        <asp:QueryStringParameter Name="categorynumber" QueryStringField="categoryno" 
            Type="Int32" />
    </SelectParameters>
</asp:SqlDataSource>
